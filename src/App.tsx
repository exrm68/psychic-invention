      ...
      <main className={`px-4 max-w-7xl mx-auto relative z-10 ${activeTab === 'home' ? '-mt-2' : 'pt-20'}`}>
        ...
        {activeTab === 'home' && (
            <>  
                ...
                <div className="fixed top-[68px] inset-x-0 z-40 bg-[#0d0d10] px-4 py-3 border-b border-white/5" style={{transform:"translateZ(0)"}}>
                ...
                {/* Filtered Grid — fixed category bar এর জন্য top padding */}
                <div className="pb-8" style={{paddingTop: "56px"}}>
